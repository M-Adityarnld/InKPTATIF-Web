    ...
    <div className="mhs-container">
      <div className="mhs-title">
        <h1 style={{ fontSize: '48px' }}>
          ...
          <span style={{ color: '#219EBC' }}>Seminar Kerja Praktik</span>
        </h1>
      </div>
      <div className="mhs-action">
        <button
          ...
          style={{borderBottom: activeButton === 'dibimbing' ? '4px solid #023047' : '4px solid #219EBC' }}>Yang dibimbing</button>
        <button
          className="mhs-select"
